...
import br.com.fiap.tech.challenge.api.agendamento.consultas.repository.ScheduleRepository;
...
import static br.com.fiap.tech.challenge.api.agendamento.consultas.exception.ErrorCode.MAX_DOCTOR_SCHEDULE_CREATED;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    private static void validateMaxDoctorSchedule(List<Schedule> schedules) {
        if (schedules.size() >= MAX_NUMBER_OF_WORKING_DAYS) {
            throw new SchedulingAppointmentsException(MAX_DOCTOR_SCHEDULE_CREATED);
        }
    }
}
